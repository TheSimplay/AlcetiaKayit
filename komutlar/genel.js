...
module.exports.run = async (bot, message, args, member, client, level) => {
  ...
  const okey = bot.emojis.find(emoji => emoji.name === "kirmizi_tik");
    ...
    .setColor('0x36393E')
        .setAuthor(`Neddanis BOT - Genel Menüsü`, 'https://cdn.discordapp.com/emojis/699687584250593341.gif')
...
.addField('**<a:kitap:772069185910997034> Genel Komutlar Menüsü;**', ':white_small_square: **n!bildir** : Bota Bildirim Verirsiniz. \n:white_small_square: **n!ping** : Botun Pingini Gösterir. \n:white_small_square: **n!havadurumu** : Belirttiğiniz Şehrin Hava Durumunu Gösterir. \n:white_small_square: **n!avatar** : Profil Resminizi Gösterir. \n:white_small_square: **n!sunucubilgi** : Sunucu Bilgilerini Gösterir. \n:white_small_square: **n!roller** : Sunucudaki Rolleri Gösterir. \n:white_small_square: **n!yetkilerim** : Sunucunuzdaki Yetkilerinizi Gösterir. \n:white_small_square: **n!say** : Sunucuyu Sayar. \n:white_small_square: **n!kadro** : Yetkili Kadrosunu Gösterir.')
...
exports.help = {
    name: 'genel',
      category: 'genel',
      description: 'Genel Menüyü Gösterir.',
};